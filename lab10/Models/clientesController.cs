...
namespace lab10.Models
{
    public class clientesController : Controller
    {
        ...
        {
            // Llama al procedimiento almacenado para realizar la eliminación lógica
            db.Database.ExecuteSqlCommand("EXEC EliminacionLogica3 @idCliente", new SqlParameter("@idCliente", id));
            db.SaveChanges();
            return RedirectToAction("Index");
        }
